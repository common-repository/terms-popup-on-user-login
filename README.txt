...
Specialized Terms and Conditions popup with premium support, available for use in six different ways: 

- On any page for everyone 
    -  
- On the login page only 
    - custom login pages supported
- Any page right after user has logged in 
    - force logout on decline available
- Any page right after user has logged in including WP Admin pages (premium only)
- At WooCommerce checkout or any special Woccomerce Cart, Product pages etc.
- Using your own custom coded condition via a WP hook (premium only)

**User action is recorded as proof in the database.**
Custom email receipts of acceptance can be sent to both admins and users as proof. (premium only)
...
= 1.0.66 =
Remove Transient handleing
Fix geo location always on.

= 1.0.65 =
Update popup logic to use javascript state object isntead of body classes
Allow for Custom URLs for Woocommerce Mode

= 1.0.64 =
Add feature to show popup on wp-admin pages.

= 1.0.63 =
Allow for more rplacement patterns in Email proof sent to user.

= 1.0.62 =
Allow for HTML in email proof
