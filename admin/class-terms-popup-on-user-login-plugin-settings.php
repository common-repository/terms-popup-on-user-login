...
class Terms_Popup_On_User_Login_Admin_Settings {
    ...
    public function term_modal_options_callback() {
        ...
        echo '<li><a href="#tpul_settings_5">' . __('Custom Login URLs', 'terms-popup-on-user-login') . '</a></li>';
...
?>
        ...
        <div class="wrap">
            ...
            // error_log(print_r($gen_options->get_options(), true));
    ...
    ?>
        ...
        function delimiter_login_page_url_render() {
            echo "<h3 id='tpul_settings_5'>5. Custom Login URLs</h3>";
