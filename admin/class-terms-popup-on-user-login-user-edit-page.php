        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <label for="tpul_user_accepted_checkbox"><?php _e("User Accepted Terms", 'terms-popup-on-user-login'); ?></label>
                    <br />
            ...
            <tr>
                <th><label for="tpul_user_accept_token"><?php _e("User Accepted Proof Token ", 'terms-popup-on-user-login'); ?></label></th>
                <td>
                    <?php if ($this->license_is_active) : ?>
