...
class Terms_Popup_On_User_Login_Modal {
    ...
    public function insert_modal_must_accept_terms() {
        ...
        if ($this->popup_type->is_loginpage_modal()) {
            ...
            $data_lastresettime = "data-lastresettime='" . $last_reset_ran . "'";
        }
        ...
        echo "<div class='ftlp_modal modal micromodal-slide' id='modal-accept-terms' aria-hidden='true' {$data_check_cookie} {$data_lastresettime}>";
        ...
        echo TPUL_Terms_Content_Service::get_terms_content();
